...
import static com.project.backend.bigdata.DpiCalculator.SPLIT_CHAR;
import static com.project.backend.bigdata.DpiCalculator.getSample;
    ...
    private static List<Sample> parse (BufferedReader br, boolean ignoreFirstLine) throws  SubmitException {
       ...
       try {
           while ((line = br.readLine()) != null) {
               ...
               Sample entry = getSample(elements);
